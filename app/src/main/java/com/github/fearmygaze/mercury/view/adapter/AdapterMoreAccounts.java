...
import com.github.fearmygaze.mercury.interfaces.IMoreAccountsAdapter;
...
public class AdapterMoreAccounts extends RecyclerView.Adapter<AdapterMoreAccounts.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (currentUser != userList.get(position).getId()) { //TODO: Remove the redundant check and add a message
