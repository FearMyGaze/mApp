...
import com.github.fearmygaze.mercury.view.adapter.AdapterMoreAccounts;
...
public class MoreAccounts extends BottomSheetDialogFragment {
    ...
    //TODO Maybe we need to remove the constructor because it is a fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        users.add(new User(11, "asd0", "http://192.168.1.6:3000/images/profile/image.png", "asd0@email.com"));
        users.add(new User(20, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
        users.add(new User(22, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
        users.add(new User(22, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
        users.add(new User(22, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
        users.add(new User(22, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
        users.add(new User(22, "asd1", "http://192.168.1.6:3000/images/profile/image.png", "asd1@email.com"));
