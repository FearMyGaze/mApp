...
//    User currentUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getIntExtra("userID", -1) != -1){
            ...
            user = database.userDao().getUserByID(id);
            Log.d("Logger",id+"");
        ...
        /*
        * TODO:
        *       (0) How to get the correct data from the login ✔
        *       (1) We need to get the appropriate User Data
        *       (2) We need to pass the values to the needed objects
        *       (3) We need to pass the data to the correct views
        * */
